...
public class Evaluate {
    ...
    public int simpleEvaluateColumn(CXCellState[][] stateBoard, CXCell cell, CXCellState player) {
        ...
        if (diagonals) {
            helpfulness += simpleCount(stateBoard, cell, player, PosDiagonal) + simpleCount(stateBoard, cell, player, NegDiagonal);
        }
        return helpfulness;
    }
     ...
     * Can return <code>WIN</code> if there are K alignments
     * 
     * @param stateBoard
     * @param cell
     * @param player
