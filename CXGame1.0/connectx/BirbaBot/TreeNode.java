...
public class TreeNode implements Comparable<TreeNode>{
  ...
  /**
   * Aggiunge tutte le mosse possibili alla lista Moves controllando se le colonne sono libere
  ...
  public void GenerateMoveList(CXBoard B) {
    ...
    // possibile ottimizzazione: generare la lista delle possibili mosse andando subito ad escludere 
    // quelle che ci faranno perdere
    // TO DO: creare una funzione possibleNonLosingMoves() che ritorna la lista delle mosse degne di essere valutate 
  }
